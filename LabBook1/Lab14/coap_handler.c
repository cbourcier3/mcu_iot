...
static ssize_t _myfunction(coap_pkt_t *pkt, uint8_t *buf, size_t len, void *context)
{
    (void)context;
    char* user = "C'est le boss de la promo";
    return coap_reply_simple(pkt, COAP_CODE_205, buf, len,
            COAP_FORMAT_TEXT, (uint8_t*)user, strlen(user));
}
...
const coap_resource_t coap_resources[] = {
    ...
    { "/riot/user", COAP_GET, _myfunction, NULL },
